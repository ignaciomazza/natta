  ...
  return (
    <svg viewBox="0 0 256 256" fill="none" {...props}>
      ...
      <rect
        width="256"
        height="256"
        fill="url(#instagram-footer-yellow)"
        rx="60"
      />
      <rect
        width="256"
        height="256"
        fill="url(#instagram-footer-blue)"
        rx="60"
      />
      <path
        fill="#fff"
...
function WhatsAppIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 256 258" fill="none" {...props}>
      <defs>
        <linearGradient
          id="whatsapp-footer-green"
          x1="50%"
          x2="50%"
          y1="100%"
          y2="0%"
      ...
      <path
        fill="url(#whatsapp-footer-green)"
        d="M5.463 127.456c-.006 21.677 5.658 42.843 16.428 61.499L4.433 252.697l65.232-17.104a123 123 0 0 0 58.8 14.97h.054c67.815 0 123.018-55.183 123.047-123.01c.013-32.867-12.775-63.773-36.009-87.025c-23.23-23.25-54.125-36.061-87.043-36.076c-67.823 0-123.022 55.18-123.05 123.004"
      />
      <path
        fill="url(#whatsapp-footer-white)"
...
function GoogleMapsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 256 367" fill="none" {...props}>
      <path
        fill="#34A853"
...
const footerLinks = [
  {
    label: "Instagram",
    detail: "@nattavascas",
    href: "https://www.instagram.com/nattavascas/",
    icon: InstagramIcon,
    iconClass: "h-10 w-10",
  },
  {
    label: "Facebook",
    detail: "Natta",
    href: "https://www.facebook.com/profile.php?id=61580534162869",
    icon: FacebookIcon,
    iconClass: "h-10 w-10",
  },
  {
    label: "WhatsApp",
    detail: "+54 9 11 7358-8459",
    href: "https://wa.me/5491173588459",
    icon: WhatsAppIcon,
    iconClass: "h-10 w-10",
  },
  {
...
export function SiteFooter({
  ...
  return (
    <footer className="section-pad bg-[var(--chocolate-deep)] pb-32 pt-14 text-[var(--milk)] md:py-16">
      <div className="content-shell grid gap-10 md:grid-cols-[0.95fr_1.45fr] md:items-start">
        ...
        <div className="grid gap-1 sm:grid-cols-2 md:gap-x-6">
            ...
            return (
              ...
              >
                <span className="flex h-12 w-12 shrink-0 items-center justify-center">
                  <Icon
                    aria-hidden="true"
                    className={`${link.iconClass} drop-shadow-[0_8px_18px_rgba(0,0,0,0.22)] transition duration-300 group-hover:scale-110`}
                  />
                </span>
                <span className="min-w-0">
                  <span className="block text-xs uppercase tracking-[0.18em] text-[var(--milk)]/48">
                    {link.label}
                  </span>
                  <span className="mt-1 block truncate text-base text-[var(--milk)]/86">
                    {link.detail}
                  </span>
                </span>
              </a>
