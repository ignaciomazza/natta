...
const requiredUniqueIndexes = [
  ...
  { table: "WeekdayCapacityRule", columns: ["branchCode", "weekday"] },
  { table: "WeekdayFlavorCapacityRule", columns: ["branchCode", "weekday", "flavorId"] },
  { table: "WeekdayFlavorSizeCapacityRule", columns: ["branchCode", "weekday", "flavorId", "sizeId"] },
  { table: "DateCapacityOverride", columns: ["branchCode", "date"] },
  { table: "DateFlavorCapacityOverride", columns: ["branchCode", "date", "flavorId"] },
  { table: "DateFlavorSizeCapacityOverride", columns: ["branchCode", "date", "flavorId", "sizeId"] },
...
const requiredColumns = [
  { table: "WeekdayCapacityRule", column: "branchCode" },
  ...
  { table: "WeekdayFlavorCapacityRule", column: "branchCode" },
  { table: "WeekdayFlavorSizeCapacityRule", column: "branchCode" },
  { table: "DateCapacityOverride", column: "branchCode" },
  ...
  { table: "DateFlavorCapacityOverride", column: "branchCode" },
  { table: "DateFlavorSizeCapacityOverride", column: "branchCode" },
  { table: "Order", column: "branchCode" },
